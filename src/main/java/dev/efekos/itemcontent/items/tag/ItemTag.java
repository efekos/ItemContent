...
import dev.efekos.itemcontent.items.compound.Display;
...
public class ItemTag {
     ...
     *
     * @param damage          Indicates how much damage this item got. gets copied into the "Damage" value you see
     *                        inside tool tags.
     * @param hideFlags       Indicates a number about the "HideFlags" value. According to its number, some information about the item becomes hidden from tooltips. To be exact:
     *                        <ul>
     ...
     *                        </ul>
     * @param display         Data of the display about item. Includes name, lore and leather armor color.
     * @param unbreakable     If true, the tooltip will show "Unbreakable" implying that this tool won't take damage when used.
     * @param customModelData A number indicating the custom model data of an item. Usually used by server-resource packs and map-specific resource packs for custom items.
     * @param enchantments    List of the enchantments the tooltip should show.
     * @param repairCost      Indicates how many level you will need to repair this tool. Goes up by 1 every time you use an anvil to repair your tool.
     */
